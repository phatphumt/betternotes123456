        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            <div className="aspect-video bg-gray-200 overflow-hidden">
              <img src="/src/assets/Respiration.png" alt="Respiration" className="w-full h-full object-cover" />
            </div>
            <div className="p-4">
          ...
          <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition" onClick={() => navigate("/pdf/plants")}>
            <div className="aspect-video bg-gray-200 overflow-hidden">
              <img src="/src/assets/plants.png" alt="พืชที่น่ารัก" className="w-full h-full object-cover" />
            </div>
            <div className="p-4">
